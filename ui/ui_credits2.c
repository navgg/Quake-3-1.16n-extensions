...
static void UI_CreditMenu2_Draw( void ) {
	...
	DRAW_WSTEP1("")
	DRAW_WSTEP1("People who host servers")	
	...
	DRAW_WSTEP1("Bana$")
	DRAW_WSTEP1("for showing noghost")
	DRAW_WSTEP1("Leon")
	...
	DRAW_WSTEP1("Danger")
	DRAW_WSTEP1("WTF")
	DRAW_WSTEP1("for testing, tips & ideas")
	DRAW_WSTEP1("")
	DRAW_WSTEP1("")
	//DRAW_WSTEP1("")
	DRAW_RSTEP1("Credits")
	DRAW_WSTEP1("Neil 'haste' Toronto - Unlagged")	
	DRAW_WSTEP1("Challenge World & The ProMode Team - CPMA")	
	DRAW_WSTEP1("Darrell \"Doolittle\" Bircsak - freeze tag")
	DRAW_WSTEP1("sst13 - cool maps")
	DRAW_WSTEP1("q3df.org - worldspawn archive")
	DRAW_WSTEP1("Id Software - Awesome Game")
	DRAW_WSTEP1("Sonic Mayhem - Awesome Music")
