...
rem start /D "%gamedir%" "" quake3.exe +devmap q3dm1 +set cg_debugEvents 1 +set cg_debugDelag 1 +set cg_showMiss 1 +set cg_drawBBox 1
...
rem start /D "%gamedir%" "" quake3.exe +set sv_pure 0 +devmap q3dm17
