...
rem start /D "%gamedir%" /MAX "" quake3.exe +connect sodmod.ml:27964 +set developer 1
rem start /D "%gamedir%" /MAX "" quake3.exe +set sv_pure 0 +devmap 13box +set g_gametype 0
