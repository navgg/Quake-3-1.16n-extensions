...
#define CGX_DATE		"11 Feb 2019" //__DATE__ not working with dd/mm/yyyy format
#define CGX_DEBUG		0
...
#define CGX_NEMESIS_COMPATIBLE 0
#else
...
#pragma warning(disable : 4068)		// pragma region
...
extern vec4_t	g_color_table_ex[36+3];
